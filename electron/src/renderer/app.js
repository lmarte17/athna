...
const COMPLETED_TASK_STATUSES = new Set(["SUCCEEDED", "FAILED"]);
...
function renderGhostStrip(contextId, contextTasks) {
...
function renderStatusFeed(contextId, contextTasks) {
...
function synchronizeTaskSelection(nextContextId, contextTasks) {
